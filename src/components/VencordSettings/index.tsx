...
const SettingsTabs: Record<string, SettingsTab> = {
    ...
    VencordPlugins: { name: "Плагины", component: () => <PluginsTab /> },
    VencordThemes: { name: "Темы", component: () => <ThemesTab /> },
    VencordUpdater: { name: "Обновления" }, // Only show updater if IS_WEB is false
    VencordSettingsSync: { name: "Бэкапы и восстановление", component: () => <BackupRestoreTab /> },
};
